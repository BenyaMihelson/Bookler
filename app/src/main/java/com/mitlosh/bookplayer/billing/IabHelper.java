...
public class IabHelper {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                verifyPurchase(purchase, mPurchaseListener);
    ...
    private void verifyPurchase(final Purchase purchase, final OnIabPurchaseFinishedListener mPurchaseListener) {
        // Verify signature
        Security.verifyPurchaseAsync(purchase.getOriginalJson(), purchase.getSignature(), new Security.OnVerifyResultListener() {
            @Override
